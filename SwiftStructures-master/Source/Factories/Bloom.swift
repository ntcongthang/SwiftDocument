...
class Bloom<T> {
    ...
    fileprivate var bloomset: Array<Bool>
    ...
    */
    ...
    init() {
        self.bloomset = Array<Bool>(repeating: false, count: capacity)
        self.empty = true
    }
    ...
    */
    ...
    fileprivate func hash<T>(_ element: T) -> Int! {
