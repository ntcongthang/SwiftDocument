...
class SortingTest: XCTestCase {
    ...
    */
    ...
    fileprivate var numberList: Array<Int>!
    fileprivate var triviaNumberList: Array<Int>!
    fileprivate var emptyNumberList: Array<Int>!
    fileprivate var textList: Array<String>!
    fileprivate var triviaTextList: Array<String>!
    fileprivate var emptyTextList: Array<String>!
    fileprivate var sortTest: Sorting!
